 ...
 * <p>
 * Created by santa on 2022-11-23.
 * <p>
 * This class is modified from the StreamTokenizer, a Java library to accumulate the token position
 * while tokenizing.
 */
public class ExpressionTokenizer {
     ...
     * @since JDK1.1
     */
    public ExpressionTokenizer(Reader r) {
        this();
        if (r == null) {
    ...
    /**
     * Perform advancement for external character.
     */
    public void advanceTokenEnd() {
        lastTokenEnd++;
    }

    /**
     * Parses the next token from the input stream of this tokenizer.
     * The type of the next token is returned to the {@code ttype}
